...
plt.savefig('notes/figures/aredi800_ohc_timeseries.png')

# Divide timeseries up into maxima/minima cycles
# Period 1: years 60-160
period1 = global_heat_detrend['aredi_800'][p1_start:p1_end]
period1_sh = heat_SH_detrend['aredi_800'][p1_start:p1_end]
...
# Period 2: years 160-260
period2 = global_heat_detrend['aredi_800'][p2_start:p2_end-10]
period2_sh = heat_SH_detrend['aredi_800'][p2_start:p2_end]
...
# Period 3: years 260-300
period3 = global_heat_detrend['aredi_800'][p3_start:p3_end]
period3_sh = heat_SH_detrend['aredi_800'][p3_start:p3_end]
...
# Period 4: years 300-360
period4 = global_heat_detrend['aredi_800'][p4_start:p4_end]
period4_sh = heat_SH_detrend['aredi_800'][p4_start:p4_end]
...
# Period 5: years 360-420
period5 = global_heat_detrend['aredi_800'][p5_start:p5_end]
period5_sh = heat_SH_detrend['aredi_800'][p5_start:p5_end]
...
# Period 6: years 420-500
period6 = global_heat_detrend['aredi_800'][p6_start:]
period6_sh = heat_SH_detrend['aredi_800'][p6_start:]
